...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@pwlived"))
        else:
            ...
            await client.join_chat("kissuXbots")
    except KeyError:
        pass
    try:
